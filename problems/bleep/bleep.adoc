...
1. Execute `cd ~/module7` to ensure that you're in `~/module7` (i.e., a directory called `pset6` that's in your home directory, aka `~`). If you haven't yet created that directory, create it now (remember how?).
