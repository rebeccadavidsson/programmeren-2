...
We've gone ahead and made a basic setup for you. The player and room classes have been separated from the main file, but it's up to you to implement their unfinished methods.

Keeping code separated is a key part of OOP, and makes your code more easily readable and maintainable. See for yourself!
